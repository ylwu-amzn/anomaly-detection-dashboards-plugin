...
export const getLatestAnomalyResultsByTimeRange = async (
  func: (request: any, resultIndex: string, onlyQueryCustomResultIndex: boolean) => APIAction,
  timeRange: string,
...
export const getAnomalyDistributionForDetectorsByTimeRange = async (
  ...
  const result = await dispatch(func(finalQuery, resultIndex, onlyQueryCustomResultIndex));
